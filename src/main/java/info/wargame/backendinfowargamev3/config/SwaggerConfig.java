package info.wargame.backendinfowargamev3.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket apiAuth() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("info.wargame.backendinfowargamev3.controller"))
                .build();
    }
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo(
                "InfoWarGame API Docs",
                "InfoWarGame Project Docs",
                "1.0.0",
